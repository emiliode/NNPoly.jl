...
t = @elapsed res, lbs_crown, ubs_crown = NP.optimise_bounds(
    aCROWN(),
    net_crown,
    input_set_acas,
    params = NP.OptimisationParams(print_freq = 25, timeout = 300, n_steps = 2000),
)
...
enc = NP.MIPEncoder(optimizer = () -> Gurobi.Optimizer())
