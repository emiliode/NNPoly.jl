...
function run_cifar10_radius_growing_lin_init_experiment(;
    patience = 2,
    properties = 1:100,
    n_unfixed = [27],
    radii = 5:50,
    ...
    model_paths = [
        CIFAR_PATH * "/onnx/cifar_relu_6_100_unnormalized.onnx",
        CIFAR_PATH * "/onnx/cifar_relu_9_200_unnormalized.onnx",
    ]
...
run_cifar10_radius_growing_lin_init_experiment(
    patience = 0,
    properties = 1:1,
    radii = [5, 10],
)
