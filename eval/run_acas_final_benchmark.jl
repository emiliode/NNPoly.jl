...
pcrown = PolyCROWNBern(use_memory_optimizations=true, bounds_method=Overapproximate, interval_repr=Dense , poly_layers = 1,threshold=THRESHOLD)
properties, times, y_starts, ys, y_hists, t_hists = verify_vnnlib(
    pcrown,
    ACAS_PATH,
    logfile = "./eval/acas_results_polycrownbern_final_dense_opt.jld2",
    max_properties = 1,
    print_freq = 1,
    n_steps = 3,
    save_history = true,
...
properties, times, y_starts, ys, y_hists, t_hists = verify_vnnlib(
    ...
    logfile = "./eval/acas_results_polycrownbern_final_mem_opt_combinedimp_overapproximate_opt.jld2",
    max_properties = 1,
    print_freq = 1,
    n_steps = 3,
    save_history = true,
...
properties, times, y_starts, ys, y_hists, t_hists = verify_vnnlib(
    ...
    #logfile = "./eval/acas_results_polycrownbern_slow_bounds_$loss_fun_name.jld2",
    #logfile = "./eval/acas_results_polycrownbern_combined_intervals_optimisation.jld2",
    logfile = "./eval/acas_results_polycrownbern_final_mem_opt_combinedimp_smithboundsoverapproximate_opt.jld2",
    max_properties = 1,
    print_freq = 1,
    n_steps = 3,
    save_history = true,
...
properties, times, y_starts, ys, y_hists, t_hists = verify_vnnlib(
    ...
    #logfile = "./eval/acas_results_polycrownbern_slow_bounds_$loss_fun_name.jld2",
    #logfile = "./eval/acas_results_polycrownbern_combined_intervals_optimisation.jld2",
    logfile = "./eval/acas_results_polycrownbern_final_mem_opt_combinedimp_smithboundsmonomon_opt.jld2",
    max_properties = 1,
    print_freq = 1,
    n_steps = 3,
    save_history = true,
...
properties, times, y_starts, ys, y_hists, t_hists = verify_vnnlib(
    ...
    #logfile = "./eval/acas_results_polycrownbern_slow_bounds_$loss_fun_name.jld2",
    #logfile = "./eval/acas_results_polycrownbern_combined_intervals_optimisation.jld2",
    logfile = "./eval/acas_results_polycrown_opt.jld2",
    max_properties = 1,
    print_freq = 1,
    n_steps = 3,
    save_history = true,
...
pcrown = PolyCROWNBern(use_memory_optimizations=false, bounds_method=Overapproximate, interval_repr=Dense , poly_layers = 1,threshold=THRESHOLD)
properties, times, y_starts, ys, y_hists, t_hists = verify_vnnlib(
    pcrown,
    ACAS_PATH,
    #logfile = "./eval/acas_results_polycrownbern_slow_bounds_$loss_fun_name.jld2",
