...
pcrown = PolyCROWNBern(bounds_method=Overapproximate, interval_repr=Imp , poly_layers = 1,threshold=THRESHOLD)
...
pcrown = PolyCROWNBern(bounds_method=Overapproximate,interval_repr=CombinedImp , poly_layers = 1, threshold=THRESHOLD)
properties, times, y_starts, ys, y_hists, t_hists = verify_vnnlib(
    pcrown,
    ACAS_PATH,
    #logfile = "./eval/acas_results_polycrownbern_slow_bounds_$loss_fun_name.jld2",
