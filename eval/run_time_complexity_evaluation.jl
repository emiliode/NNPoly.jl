...
function run_time_complexity(; properties = 1:5, n_unfixed = 5:5:100, pruning = true)
    solver = PolyCROWN(
        NP.DiffNNPolySym(common_generators = true, truncation_terms = 10000),
        prune_neurons = pruning,
    )  # don't truncate here
    ...
    #n_unfixed = 5:5:100
    model_paths = [
        MNIST_PATH * "/onnx/mnist-net_256x2.onnx",
        MNIST_PATH * "/onnx/mnist-net_256x4.onnx",
        MNIST_PATH * "/onnx/mnist-net_256x6.onnx",
    ]
