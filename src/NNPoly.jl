...
include("polynomial_representation/bernstein_imp.jl")
...
include("reachability/bernstein_interval.jl")
include("reachability/combined_bernstein_interval.jl")
include("reachability/dense_bernstein_interval.jl")
include("reachability/bern_sym.jl")
include("reachability/poly_crown_bern.jl")
